...
template class ActionNode<int_8b, float_4b>;
using ANType = ActionNode<int_8b, float_4b>;
template class ActionTree<ANType, int_8b, float_4b>;
using ATType = ActionTree<ANType, int_8b, float_4b>;
